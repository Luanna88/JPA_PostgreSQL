...
public class App {
    public static void main(String[] args) {
        ...
        try {
            ...
            Livro harryPotter = new Livro("Harry Potter", 1999, "123456789", acao, editora1, autores);
            ...
            Livro piorQueTaNaoFica = new Livro("Pior que tá não fica?", 2010, "987654321", comedia, editora2, autores);
            livroDAO.save(piorQueTaNaoFica);

            autores.clear();
            autores.add(autor1);

            Livro oEspadachim = new Livro("O Espadachim", 2022, "111111111", romance, editora3, autores);
